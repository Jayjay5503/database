...
if (isset($_POST['btnSubmitUser'])) {
  ...
  $userQuery = "INSERT INTO userinfo (firstName, lastName, birthDay) VALUES ('$firstName', '$lastName', '$birthDay')";
            ...
            <div class="card p-3">
              ...
              <form method="post" action="delete.php">
                ...
                <div class="d-flex">
                  ...
                  <a href="edit.php?id=<?php echo $user['userInfoID']; ?>" class="btn btn-warning">Edit</a>
                </div>
              </form>
            </div>
          </div>
