...
<body>
  <div class="container">
      ...
      <div class="col-12">
        <form>
          <div class="card p-4 rounded-5">
            <div class="h2 text-center mb-5 p-2" style="background-color: #879A77; color: black;">
    ...
    <div class="row my-5">
      <div class="col-12">
        <div class="card p-4 rounded-5">
        <h1 class="text-center mb-4 p-3" style="background-color: #879A77; color: black;">
          <i class="bi bi-airplane"></i> Flight Logs
          </h1>
